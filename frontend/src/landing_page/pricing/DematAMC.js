...
function DematAMC() {
    ...
    return (
       ...
       <p className='text-center'>* Lower AMC is applicable only if the account qualifies as a Basic Services Demat Account (BSDA). BSDA account holders cannot hold more than one demat account. To learn more about BSDA, <a href='http://localhost:5000/pricing'>click here</a>
